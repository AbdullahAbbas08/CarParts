...
namespace API.Services
{
    public static partial class ServicesRegistration
    {
        ...
        public static async Task SeedBrands(DatabaseContext dbContext)
        {
            ...
            {
                new Brand { Name = "تويوتا", Code = "TOYOTA", ImageUrl = "", IsActive = true },
                new Brand { Name = "هيونداي", Code = "HYUNDAI", ImageUrl = "", IsActive = true },
                new Brand { Name = "كيا", Code = "KIA", ImageUrl = "", IsActive = true },
                new Brand { Name = "شيفروليه", Code = "CHEVROLET", ImageUrl = "", IsActive = true },
                new Brand { Name = "نيسان", Code = "NISSAN", ImageUrl = "", IsActive = true },
                new Brand { Name = "ميتسوبيشي", Code = "MITSUBISHI", ImageUrl = "", IsActive = true },
                new Brand { Name = "فورد", Code = "FORD", ImageUrl = "", IsActive = true },
                new Brand { Name = "بي إم دبليو", Code = "BMW", ImageUrl = "", IsActive = true },
                new Brand { Name = "مرسيدس", Code = "MERCEDES", ImageUrl = "", IsActive = true },
                new Brand { Name = "رينو", Code = "RENAULT", ImageUrl = "", IsActive = true },
                new Brand { Name = "هوندا", Code = "HONDA", ImageUrl = "", IsActive = true },
                new Brand { Name = "أوبل", Code = "OPEL", ImageUrl = "", IsActive = true },
                new Brand { Name = "جيلي", Code = "GEELY", ImageUrl = "", IsActive = true },
                new Brand { Name = "سوزوكي", Code = "SUZUKI", ImageUrl = "", IsActive = true },
                new Brand { Name = "بيجو", Code = "PEUGEOT", ImageUrl = "", IsActive = true },
                new Brand { Name = "سكودا", Code = "SKODA", ImageUrl = "", IsActive = true },
                new Brand { Name = "فولكس فاجن", Code = "VOLKSWAGEN", ImageUrl = "", IsActive = true },
                new Brand { Name = "جيب", Code = "JEEP", ImageUrl = "", IsActive = true },
                new Brand { Name = "داسيا", Code = "DACIA", ImageUrl = "", IsActive = true },
                new Brand { Name = "سيات", Code = "SEAT", ImageUrl = "", IsActive = true },
                new Brand { Name = "شيري", Code = "CHERY", ImageUrl = "", IsActive = true },
                new Brand { Name = "BYD", Code = "BYD", ImageUrl = "", IsActive = true },
                new Brand { Name = "MG", Code = "MG", ImageUrl = "", IsActive = true },
                new Brand { Name = "لادا", Code = "LADA", ImageUrl = "", IsActive = true },
                new Brand { Name = "سانج يونج", Code = "SSANGYONG", ImageUrl = "", IsActive = true },
                new Brand { Name = "فاو", Code = "FAW", ImageUrl = "", IsActive = true },
                new Brand { Name = "بروتون", Code = "PROTON", ImageUrl = "", IsActive = true },
                new Brand { Name = "إم جي", Code = "EMG", ImageUrl = "", IsActive = true },
                new Brand { Name = "سوبارو", Code = "SUBARU", ImageUrl = "", IsActive = true },
                new Brand { Name = "هونداي", Code = "HYUNDAI2", ImageUrl = "", IsActive = true },
                new Brand { Name = "تسلا", Code = "TESLA", ImageUrl = "", IsActive = true },
                new Brand { Name = "أودي", Code = "AUDI", ImageUrl = "", IsActive = true },
                new Brand { Name = "بورش", Code = "PORSCHE", ImageUrl = "", IsActive = true },
                new Brand { Name = "مازدا", Code = "MAZDA", ImageUrl = "", IsActive = true },
                new Brand { Name = "كرايسلر", Code = "CHRYSLER", ImageUrl = "", IsActive = true },
                new Brand { Name = "إيسوزو", Code = "ISUZU", ImageUrl = "", IsActive = true },
                new Brand { Name = "سيتروين", Code = "CITROEN", ImageUrl = "", IsActive = true },
                new Brand { Name = "دايو", Code = "DAEWOO", ImageUrl = "", IsActive = true },
                new Brand { Name = "فيات", Code = "FIAT", ImageUrl = "", IsActive = true },
                new Brand { Name = "رام", Code = "RAM", ImageUrl = "", IsActive = true },
                new Brand { Name = "لينكولن", Code = "LINCOLN", ImageUrl = "", IsActive = true },
                new Brand { Name = "سوزوكي2", Code = "SUZUKI2", ImageUrl = "", IsActive = true },
                new Brand { Name = "هامر", Code = "HUMMER", ImageUrl = "", IsActive = true },
                new Brand { Name = "إنفينيتي", Code = "INFINITI", ImageUrl = "", IsActive = true },
                new Brand { Name = "أكورا", Code = "ACURA", ImageUrl = "", IsActive = true },
                new Brand { Name = "بيوك", Code = "BUICK", ImageUrl = "", IsActive = true },
                new Brand { Name = "كاديلاك", Code = "CADILLAC", ImageUrl = "", IsActive = true },
                new Brand { Name = "دودج", Code = "DODGE", ImageUrl = "", IsActive = true },
                new Brand { Name = "فولفو", Code = "VOLVO", ImageUrl = "", IsActive = true },
                new Brand { Name = "ميني", Code = "MINI", ImageUrl = "", IsActive = true },
                new Brand { Name = "روفر", Code = "ROVER", ImageUrl = "", IsActive = true },
                new Brand { Name = "سوزوكي3", Code = "SUZUKI3", ImageUrl = "", IsActive = true },
                new Brand { Name = "هونداي3", Code = "HYUNDAI3", ImageUrl = "", IsActive = true },
                new Brand { Name = "بي إم دبليو2", Code = "BMW2", ImageUrl = "", IsActive = true },
                new Brand { Name = "مرسيدس2", Code = "MERCEDES2", ImageUrl = "", IsActive = true },
                new Brand { Name = "تويوتا2", Code = "TOYOTA2", ImageUrl = "", IsActive = true }
            };
        ...
        public static async Task SeedCountryOfManufacture(DatabaseContext dbContext)
        {
            if (dbContext == null) return;
            if (await dbContext.Set<CountryOfManufacture>().AnyAsync()) return;

            var countries = new List<CountryOfManufacture>
            {
                new CountryOfManufacture { Name = "أفغانستان" },
                new CountryOfManufacture { Name = "ألبانيا" },
                new CountryOfManufacture { Name = "الجزائر" },
                new CountryOfManufacture { Name = "أندورا" },
                new CountryOfManufacture { Name = "أنغولا" },
                new CountryOfManufacture { Name = "أنتيغوا وبربودا" },
                new CountryOfManufacture { Name = "الأرجنتين" },
                new CountryOfManufacture { Name = "أرمينيا" },
                new CountryOfManufacture { Name = "أستراليا" },
                new CountryOfManufacture { Name = "النمسا" },
                new CountryOfManufacture { Name = "أذربيجان" },
                new CountryOfManufacture { Name = "الباهاما" },
                new CountryOfManufacture { Name = "البحرين" },
                new CountryOfManufacture { Name = "بنغلاديش" },
                new CountryOfManufacture { Name = "بربادوس" },
                new CountryOfManufacture { Name = "بيلاروس" },
                new CountryOfManufacture { Name = "بلجيكا" },
                new CountryOfManufacture { Name = "بليز" },
                new CountryOfManufacture { Name = "بنين" },
                new CountryOfManufacture { Name = "بوتان" },
                new CountryOfManufacture { Name = "بوليفيا" },
                new CountryOfManufacture { Name = "البوسنة والهرسك" },
                new CountryOfManufacture { Name = "بوتسوانا" },
                new CountryOfManufacture { Name = "البرازيل" },
                new CountryOfManufacture { Name = "بروناي" },
                new CountryOfManufacture { Name = "بلغاريا" },
                new CountryOfManufacture { Name = "بوركينا فاسو" },
                new CountryOfManufacture { Name = "بوروندي" },
                new CountryOfManufacture { Name = "الرأس الأخضر" },
                new CountryOfManufacture { Name = "كمبوديا" },
                new CountryOfManufacture { Name = "الكاميرون" },
                new CountryOfManufacture { Name = "كندا" },
                new CountryOfManufacture { Name = "جمهورية أفريقيا الوسطى" },
                new CountryOfManufacture { Name = "تشاد" },
                new CountryOfManufacture { Name = "تشيلي" },
                new CountryOfManufacture { Name = "الصين" },
                new CountryOfManufacture { Name = "كولومبيا" },
                new CountryOfManufacture { Name = "جزر القمر" },
                new CountryOfManufacture { Name = "جمهورية الكونغو الديمقراطية" },
                new CountryOfManufacture { Name = "جمهورية الكونغو" },
                new CountryOfManufacture { Name = "كوستاريكا" },
                new CountryOfManufacture { Name = "ساحل العاج" },
                new CountryOfManufacture { Name = "كرواتيا" },
                new CountryOfManufacture { Name = "كوبا" },
                new CountryOfManufacture { Name = "قبرص" },
                new CountryOfManufacture { Name = "جمهورية التشيك" },
                new CountryOfManufacture { Name = "الدنمارك" },
                new CountryOfManufacture { Name = "جيبوتي" },
                new CountryOfManufacture { Name = "دومينيكا" },
                new CountryOfManufacture { Name = "جمهورية الدومينيكان" },
                new CountryOfManufacture { Name = "الإكوادور" },
                new CountryOfManufacture { Name = "مصر" },
                new CountryOfManufacture { Name = "السلفادور" },
                new CountryOfManufacture { Name = "غينيا الاستوائية" },
                new CountryOfManufacture { Name = "إريتريا" },
                new CountryOfManufacture { Name = "إستونيا" },
                new CountryOfManufacture { Name = "إسواتيني" },
                new CountryOfManufacture { Name = "إثيوبيا" },
                new CountryOfManufacture { Name = "فيجي" },
                new CountryOfManufacture { Name = "فنلندا" },
                new CountryOfManufacture { Name = "فرنسا" },
                new CountryOfManufacture { Name = "الغابون" },
                new CountryOfManufacture { Name = "غامبيا" },
                new CountryOfManufacture { Name = "جورجيا" },
                new CountryOfManufacture { Name = "ألمانيا" },
                new CountryOfManufacture { Name = "غانا" },
                new CountryOfManufacture { Name = "اليونان" },
                new CountryOfManufacture { Name = "غرينادا" },
                new CountryOfManufacture { Name = "غواتيمالا" },
                new CountryOfManufacture { Name = "غينيا" },
                new CountryOfManufacture { Name = "غينيا بيساو" },
                new CountryOfManufacture { Name = "غيانا" },
                new CountryOfManufacture { Name = "هايتي" },
                new CountryOfManufacture { Name = "هندوراس" },
                new CountryOfManufacture { Name = "المجر" },
                new CountryOfManufacture { Name = "آيسلندا" },
                new CountryOfManufacture { Name = "الهند" },
                new CountryOfManufacture { Name = "إندونيسيا" },
                new CountryOfManufacture { Name = "إيران" },
                new CountryOfManufacture { Name = "العراق" },
                new CountryOfManufacture { Name = "أيرلندا" },
                new CountryOfManufacture { Name = "إسرائيل" },
                new CountryOfManufacture { Name = "إيطاليا" },
                new CountryOfManufacture { Name = "جامايكا" },
                new CountryOfManufacture { Name = "اليابان" },
                new CountryOfManufacture { Name = "الأردن" },
                new CountryOfManufacture { Name = "كازاخستان" },
                new CountryOfManufacture { Name = "كينيا" },
                new CountryOfManufacture { Name = "كيريباتي" },
                new CountryOfManufacture { Name = "كوريا الشمالية" },
                new CountryOfManufacture { Name = "كوريا الجنوبية" },
                new CountryOfManufacture { Name = "كوسوفو" },
                new CountryOfManufacture { Name = "الكويت" },
                new CountryOfManufacture { Name = "قرغيزستان" },
                new CountryOfManufacture { Name = "لاوس" },
                new CountryOfManufacture { Name = "لاتفيا" },
                new CountryOfManufacture { Name = "لبنان" },
                new CountryOfManufacture { Name = "ليسوتو" },
                new CountryOfManufacture { Name = "ليبيريا" },
                new CountryOfManufacture { Name = "ليبيا" },
                new CountryOfManufacture { Name = "ليختنشتاين" },
                new CountryOfManufacture { Name = "ليتوانيا" },
                new CountryOfManufacture { Name = "لوكسمبورغ" },
                new CountryOfManufacture { Name = "مدغشقر" },
                new CountryOfManufacture { Name = "مالاوي" },
                new CountryOfManufacture { Name = "ماليزيا" },
                new CountryOfManufacture { Name = "المالديف" },
                new CountryOfManufacture { Name = "مالي" },
                new CountryOfManufacture { Name = "مالطا" },
                new CountryOfManufacture { Name = "جزر مارشال" },
                new CountryOfManufacture { Name = "موريتانيا" },
                new CountryOfManufacture { Name = "موريشيوس" },
                new CountryOfManufacture { Name = "المكسيك" },
                new CountryOfManufacture { Name = "ميكرونيزيا" },
                new CountryOfManufacture { Name = "مولدوفا" },
                new CountryOfManufacture { Name = "موناكو" },
                new CountryOfManufacture { Name = "منغوليا" },
                new CountryOfManufacture { Name = "الجبل الأسود" },
                new CountryOfManufacture { Name = "المغرب" },
                new CountryOfManufacture { Name = "موزمبيق" },
                new CountryOfManufacture { Name = "ميانمار" },
                new CountryOfManufacture { Name = "ناميبيا" },
                new CountryOfManufacture { Name = "ناورو" },
                new CountryOfManufacture { Name = "نيبال" },
                new CountryOfManufacture { Name = "هولندا" },
                new CountryOfManufacture { Name = "نيوزيلندا" },
                new CountryOfManufacture { Name = "نيكاراغوا" },
                new CountryOfManufacture { Name = "النيجر" },
                new CountryOfManufacture { Name = "نيجيريا" },
                new CountryOfManufacture { Name = "مقدونيا الشمالية" },
                new CountryOfManufacture { Name = "النرويج" },
                new CountryOfManufacture { Name = "عمان" },
                new CountryOfManufacture { Name = "باكستان" },
                new CountryOfManufacture { Name = "بالاو" },
                new CountryOfManufacture { Name = "فلسطين" },
                new CountryOfManufacture { Name = "بنما" },
                new CountryOfManufacture { Name = "بابوا غينيا الجديدة" },
                new CountryOfManufacture { Name = "باراغواي" },
                new CountryOfManufacture { Name = "بيرو" },
                new CountryOfManufacture { Name = "الفلبين" },
                new CountryOfManufacture { Name = "بولندا" },
                new CountryOfManufacture { Name = "البرتغال" },
                new CountryOfManufacture { Name = "قطر" },
                new CountryOfManufacture { Name = "رومانيا" },
                new CountryOfManufacture { Name = "روسيا" },
                new CountryOfManufacture { Name = "رواندا" },
                new CountryOfManufacture { Name = "سانت كيتس ونيفيس" },
                new CountryOfManufacture { Name = "سانت لوسيا" },
                new CountryOfManufacture { Name = "سانت فنسنت والغرينادين" },
                new CountryOfManufacture { Name = "ساموا" },
                new CountryOfManufacture { Name = "سان مارينو" },
                new CountryOfManufacture { Name = "ساو تومي وبرينسيب" },
                new CountryOfManufacture { Name = "المملكة العربية السعودية" },
                new CountryOfManufacture { Name = "السنغال" },
                new CountryOfManufacture { Name = "صربيا" },
                new CountryOfManufacture { Name = "سيشيل" },
                new CountryOfManufacture { Name = "سيراليون" },
                new CountryOfManufacture { Name = "سنغافورة" },
                new CountryOfManufacture { Name = "سلوفاكيا" },
                new CountryOfManufacture { Name = "سلوفينيا" },
                new CountryOfManufacture { Name = "جزر سليمان" },
                new CountryOfManufacture { Name = "الصومال" },
                new CountryOfManufacture { Name = "جنوب أفريقيا" },
                new CountryOfManufacture { Name = "جنوب السودان" },
                new CountryOfManufacture { Name = "إسبانيا" },
                new CountryOfManufacture { Name = "سريلانكا" },
                new CountryOfManufacture { Name = "السودان" },
                new CountryOfManufacture { Name = "سورينام" },
                new CountryOfManufacture { Name = "السويد" },
                new CountryOfManufacture { Name = "سويسرا" },
                new CountryOfManufacture { Name = "سوريا" },
                new CountryOfManufacture { Name = "تايوان" },
                new CountryOfManufacture { Name = "طاجيكستان" },
                new CountryOfManufacture { Name = "تنزانيا" },
                new CountryOfManufacture { Name = "تايلاند" },
                new CountryOfManufacture { Name = "تيمور الشرقية" },
                new CountryOfManufacture { Name = "توغو" },
                new CountryOfManufacture { Name = "تونغا" },
                new CountryOfManufacture { Name = "ترينيداد وتوباغو" },
                new CountryOfManufacture { Name = "تونس" },
                new CountryOfManufacture { Name = "تركيا" },
                new CountryOfManufacture { Name = "تركمانستان" },
                new CountryOfManufacture { Name = "توفالو" },
                new CountryOfManufacture { Name = "أوغندا" },
                new CountryOfManufacture { Name = "أوكرانيا" },
                new CountryOfManufacture { Name = "الإمارات العربية المتحدة" },
                new CountryOfManufacture { Name = "المملكة المتحدة" },
                new CountryOfManufacture { Name = "الولايات المتحدة" },
                new CountryOfManufacture { Name = "أوروغواي" },
                new CountryOfManufacture { Name = "أوزبكستان" },
                new CountryOfManufacture { Name = "فانواتو" },
                new CountryOfManufacture { Name = "مدينة الفاتيكان" },
                new CountryOfManufacture { Name = "فنزويلا" },
                new CountryOfManufacture { Name = "فيتنام" },
                new CountryOfManufacture { Name = "اليمن" },
                new CountryOfManufacture { Name = "زامبيا" },
                new CountryOfManufacture { Name = "زيمبابوي" }
            };
            dbContext.Set<CountryOfManufacture>().AddRange(countries);
            await dbContext.SaveChangesAsync();
        }
    }
}
